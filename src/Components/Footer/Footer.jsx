import logo from "../../assets/Images/Navbar/Startup dark-mode-logo.svg";
import blog1 from "../../assets/Images/Footer/blog-01.jpg";
import blog2 from "../../assets/Images/Footer/blog-02.jpg";
export default function Footer() {
  return (
    <>
      <footer className="bg-[#3758F9] py-9 px-4 sm:px-12 lg:px-16 xl:px-28">
        <div className="flex flex-col lg:flex-row lg:items-center lg:gap-14 py-8 border-gray-300/25 border-b">
          <h1 className="font-bold text-2xl sm:text-3xl sm:w-[25ch] text-white font-oswald">
            Signup for latest news and insights from TailGrids UI
          </h1>
          <form
            className="flex flex-col sm:flex-row lg:flex-col xl:flex-row xl:justify-between gap-3 items-start my-4"
            action="#"
          >
            <label className="relative inline-block">
              <svg
                className="absolute left-4 sm:left-8 top-7 sm:top-4 lg:top-7 xl:top-4"
                width="20"
                height="20"
                viewBox="0 0 20 20"
                fill="none"
            ...
            <input
              ...
              className="px-14 py-3.5 sm:px-20 rounded-md bg-gray-100/10 focus:border text-white focus:border-gray-300 focus:outline-none placeholder-gray-200"
            />
            <button className="bg-white text-lg px-8 py-3.5 rounded-lg hover:bg-gray-300 font-oswald">
              Subscribe
            </button>
          </form>
        </div>
        <div className="flex flex-col sm:flex-row sm:flex-wrap xl:gap-10 lg:gap-16 gap-20 my-16">
          <div className="flex flex-col gap-6">
            <img src={logo} alt="" className="w-40" />
            <p className="text-gray-300 sm:w-[50ch] lg:w-[30ch]">
            ...
            <span className="flex gap-6">
              <svg
                ...
                height="18"
                viewBox="0 0 10 18"
                className="fill-[#ced4da] hover:fill-white"
              >
          ...
          <div className="flex flex-col gap-6">
            <h3 className="text-white font-medium text-xl mb-4 font-oswald">
              Latest blog
            </h3>
            <div className="flex gap-6 items-center">
              <img src={blog1} alt="" className="rounded" />
              <a href="#" className="text-gray-300 w-[25ch] hover:text-white">
                I think really imprtant to desaign...
              </a>
            </div>
            <div className="flex gap-6 items-center">
              <img src={blog2} alt="" className="rounded" />
              <a href="#" className="text-gray-300 w-[25ch] hover:text-white">
                Recpgnizing the need is the primary...
              </a>
            </div>
          </div>
          <div>
            <h3 className="text-white font-medium text-xl mb-8 font-oswald">
              Company
            </h3>
            <ol className="flex flex-col gap-4 text-gray-300">
              ...
              <li className="hover:text-white hover:underline">
                <a href="#">Job oppertunities</a>
              </li>
              <li className="hover:text-white hover:underline">
                <a href="#">Creative poeple</a>
              </li>
            </ol>
          </div>
          <div>
            <h3 className="text-white font-medium text-sans text-2xl mb-8 font-oswald">
              Customer
            </h3>
            <ol className="flex flex-col gap-4 text-gray-300">
              <li className="hover:text-white hover:underline">
          ...
          <div className="flex flex-col gap-4">
            <h3 className="text-white font-medium text-sans text-xl mb-8 font-oswald">
              Contact Info
            </h3>
            <ol className="flex flex-col gap-5 text-gray-300">
              ...
              <li className="flex gap-4 items-center lg:w-[20ch]">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
      ...
      <div className="bg-[#0e133a] flex flex-col sm:flex-row sm:justify-between items-center gap-3 p-8 sm:px-12 lg:px-16 xl:px-28 w-full text-gray-300">
        <h3 className="text-gray-300 hover:text-white cursor-pointer">
          © 2025 Hasibullah Sahibzada | TailGrids
        </h3>
        <ul className="flex flex-col sm:flex-row items-center gap-1 sm:gap-8 text-white">
