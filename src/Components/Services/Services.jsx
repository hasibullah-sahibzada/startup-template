import ServicesBg from "../../assets/Images/Services/services bg-image.jpg";

export default function Services() {
  return (
    <>
      <section className="flex flex-col items-center gap-16 px-3 sm:px-10 xl:px-28 bg-white dark:bg-[#111928]">
        <div className="flex flex-col items-center gap-2 sm:gap-3">
          <h2 className="text-[#3758F9] text-xl font-bold">What we serve</h2>
          <h1 className="text-3xl sm:text-5xl dark:text-white font-bold font-oswald w-[16ch] text-center">
            Our Best services
          </h1>
          <p className="text-gray-500 dark:text-gray-400 leading-6 w-[38ch] sm:w-[55ch] text-center">
            There are many variations of passages of Lorem Ipsum available but
            the majority have suffered alteration in some form.
          </p>
        </div>

        <div className="flex flex-col gap-6 sm:gap-8 lg:gap-8 sm:flex-row sm:flex-wrap xl:gap-16 items-center pb-20 sm:justify-center text-center">
          <div className="flex flex-col items-center dark:bg-[#1f2a32] gap-4 p-10 sm:p-12 lg:px-8 xl:px-20 border border-gray-300 dark:border-gray-600 rounded-xl dark:hover:shadow-none hover:shadow-[0_12px_16px_-1px_rgba(55,88,249,0.15)]">
            ...
            <h2 className="text-2xl dark:text-white md:mt-1 font-bold font-oswald">
              Marketing Solutions
            </h2>
            <p className="sm:text-sm text-gray-500 dark:text-gray-400 w-[30ch]">
          ...
          <div className="flex flex-col items-center dark:bg-[#1f2a32] gap-4 p-10 sm:p-12 lg:px-8 xl:px-20 border border-gray-300 dark:border-gray-600 rounded-xl dark:hover:shadow-none hover:shadow-[0_12px_16px_-1px_rgba(55,88,249,0.15)]">
            ...
            <h2 className="text-2xl dark:text-white font-bold font-oswald">
              Business Analytics
            </h2>
            <p className="sm:text-sm text-gray-500 dark:text-gray-400 w-[30ch]">
              Lorem Ipsum is simply dummy text of the printing and industry.
          ...
          <div className="flex flex-col items-center dark:bg-[#1f2a32] gap-4 p-10 sm:p-12 lg:px-8 xl:px-20 border border-gray-300 dark:border-gray-600 rounded-xl dark:hover:shadow-none hover:shadow-[0_12px_16px_-1px_rgba(55,88,249,0.15)]">
            ...
            <h2 className="text-2xl dark:text-white font-bold whitespace-nowrap font-oswald">
              UX & UI Design
            </h2>
            <p className="sm:text-sm text-gray-500 dark:text-gray-400 w-[30ch]">
              Lorem Ipsum is simply dummy text of the printing and industry.
      ...
      <section className="flex flex-col lg:flex-row justify-center">
        <div className="bg-[#3758F9] pb-16 lg:pb-0 lg:w-[50vw]">
          <div className="flex flex-row justify-end px-2 py-4">
            <svg width="58" height="83" viewBox="0 0 58 83" fill="none">
              <circle cx="1.5" cy="1.5" r="1.5" fill="#ffffff" />
              <circle cx="1.5" cy="15.5" r="1.5" fill="#ffffff" />
              <circle cx="1.5" cy="29.5" r="1.5" fill="#ffffff" />
              <circle cx="1.5" cy="43.5" r="1.5" fill="#ffffff" />
              <circle cx="1.5" cy="57.5" r="1.5" fill="#ffffff" />
              <circle cx="1.5" cy="71.5" r="1.5" fill="#ffffff" />

              <circle cx="15.5" cy="1.5" r="1.5" fill="#ffffff" />
              <circle cx="15.5" cy="15.5" r="1.5" fill="#ffffff" />
              <circle cx="15.5" cy="29.5" r="1.5" fill="#ffffff" />
              <circle cx="15.5" cy="43.5" r="1.5" fill="#ffffff" />
              <circle cx="15.5" cy="57.5" r="1.5" fill="#ffffff" />
              <circle cx="15.5" cy="71.5" r="1.5" fill="#ffffff" />

              <circle cx="29.5" cy="1.5" r="1.5" fill="#ffffff" />
              <circle cx="29.5" cy="15.5" r="1.5" fill="#ffffff" />
              <circle cx="29.5" cy="29.5" r="1.5" fill="#ffffff" />
              <circle cx="29.5" cy="43.5" r="1.5" fill="#ffffff" />
              <circle cx="29.5" cy="57.5" r="1.5" fill="#ffffff" />
              <circle cx="29.5" cy="71.5" r="1.5" fill="#ffffff" />

              <circle cx="43.5" cy="1.5" r="1.5" fill="#ffffff" />
              <circle cx="43.5" cy="15.5" r="1.5" fill="#ffffff" />
              <circle cx="43.5" cy="29.5" r="1.5" fill="#ffffff" />
              <circle cx="43.5" cy="43.5" r="1.5" fill="#ffffff" />
              <circle cx="43.5" cy="57.5" r="1.5" fill="#ffffff" />
              <circle cx="43.5" cy="71.5" r="1.5" fill="#ffffff" />
            </svg>
          </div>
          <div className="text-white px-4 sm:px-10 xl:px-28 flex flex-col gap-6 items-start">
            <h4 className="text-lg font-bold ">Watch Our Intro Video</h4>
            <h1 className="text-3xl sm:text-5xl lg:text-4xl xl:text-5xl font-bold w-[20ch] font-oswald">
              Making world a better place for you and us
            </h1>
            <p className="w-[40ch] sm:w-[47ch]">
            ...
            <a
              href="#"
              className="py-3 px-8 rounded-full font-medium border mt-2 hover:bg-white hover:text-[#3758F9]"
            >
              Know More
            </a>
          </div>
        ...
        <div
          className="flex flex-col items-center justify-center w-[100vw] h-[65vh] sm:h-[120vh] lg:w-[50vw] lg:h-[90vh] xl:h-[70vh]"
          style={{
        ...
        >
          <span className="bg-[#3758F9] cursor-pointer p-7 rounded-full">
            <svg
              width="28"
              height="28"
              viewBox="0 0 23 27"
